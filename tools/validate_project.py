...
require("android.useAndroidX=true" in gradle_props, "ML Kit requires android.useAndroidX=true")
require("android.enableJetifier=false" in gradle_props, "Jetifier must stay disabled because all dependencies are already AndroidX")
...
require("versionName '0.4.3-b4.3'" in app_build, "B4.3 versionName mismatch")
require("versionCode 10" in app_build, "B4.3 versionCode mismatch")
...
require("dist/AdGuardian-B4.3.apk" in workflow, "workflow must publish B4.3 APK filename")
...
require("Verify uploaded B4.3 source" in workflow, "workflow must verify the uploaded B4.3 source before building")
...
print("AdGuardian B4.3 static project checks passed")
